      ...
      <div className='mx-auto w-full max-w-md px-6 py-6'>
        ...
        <form className='space-y-5'>
          ...
          <div className='flex items-center justify-center gap-6'>
            <button
              type='button'
              className='flex h-14 w-14 items-center justify-center rounded-full border bg-white text-gray-700 shadow-sm hover:bg-gray-50'
          ...
          <div className='pt-8 text-center'>
            <button
              type='button'
              className='mb-4 block w-full text-base font-semibold text-primary'
            >
              Quên mật khẩu?
            </button>
            <button
